...
public class IncrementScienceCommand implements ClientToServerCommand {

	private static final long serialVersionUID = -6796324295742880632L;
	private int gameId;
	private TurnData turnData;

	public IncrementScienceCommand() {
		this.gameId = ClientModel.instance.getGameStateManager().getGameId();
		this.turnData = new TurnData(TurnAction.SCIENCE_CITY_IMPROVEMENT);
	}
