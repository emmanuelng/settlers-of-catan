...
public class HexagonImage extends MinuetoImage {
	...
	public static boolean notAlternateVertex = true; // if this is true it means
														// that the coordinate
														// (0,0) are coordinates
														// of the first vertex.
	// if it is false it means that the coordinate are coordinates of the top
	// left rectangle.
	...
	public static void setHeight(int height) {
		h = height; // distance between two centres, or the size of the
					// coordinate
		r = h / 2; // radius of the inscribed circle
		t = (int) (h / 1.73205); // short side is (h/2)/cos30 = (h/2)/(sqrt(3)/2
									// = h/sqrt(3)
		s = (int) (r / 1.73205); // side length is (h/2) tan30 = h/2/sqrt(3) =
									// radius/sqrt(3)
